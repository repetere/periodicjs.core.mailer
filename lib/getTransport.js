...
function getTransport(options = {}) {
  return new Promise((resolve, reject) => {
    try {
      ...
      let nodemailerTransporter = nodemailer.createTransport(transportObject.type, transportObject.transportoptions);

      if (transportMap[transportObject.type]) {
        nodemailerTransporter = nodemailer.createTransport(transportMap[transportObject.type](transportObject.transportoptions));
      }
