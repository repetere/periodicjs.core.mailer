...
class Mailer {
  ...
  constructor(options = {}) {
     ...
     * @memberof Mailer
     */
  static getEmailTemplateHTMLString = getEmailTemplateHTMLString
    /**
     ...
     * @memberof Mailer
     */
  static getTransport = getTransport
    /**
        ...
        Promise.resolve(mailoptions)
          ...
          .then(mailhtml => {
            if (mailtransport.sendMail) {
              ...
              getTransport({ transportObject: mailTransportConfig })
                .then(transport => {
          ...
          .then(mt => {
            mt.sendMail(mailoptions, resolve);
          })
          .catch(reject);
      } catch (e) {
        reject(e);
